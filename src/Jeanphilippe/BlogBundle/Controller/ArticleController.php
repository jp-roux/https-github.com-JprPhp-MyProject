...
class ArticleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JeanphilippeBlogBundle:Article')->findAll();
     ...
     * @Method("POST")
     * @Template("JeanphilippeBlogBundle:Article:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JeanphilippeBlogBundle:Article')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JeanphilippeBlogBundle:Article:edit.html.twig")
     */
